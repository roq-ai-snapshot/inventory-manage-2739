  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Inventory Management System: Streamlining Your Operations with Barcode Scanners at Every Touchpoint. Learn More Today!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1545941962-1b6654eb8072?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiYXJjb2RlfGVufDB8fHx8MTY5ODI5OTcwNnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Inventory Management System: Streamlining Your Operations with Barcode Scanners at Every Touchpoint. Learn More Today!`}
            </Text>
            <Box
